...
export const LEAD_STATUS_COLORS = {
  ...
  CALLED: "bg-yellow-50 text-yellow-700 ring-1 ring-yellow-600/20",
  ...
  FOLLOW_UP: "bg-orange-50 text-orange-700 ring-1 ring-orange-600/20",
  WRONG_NUMBER: "bg-gray-50 text-gray-600 ring-1 ring-gray-500/20",
